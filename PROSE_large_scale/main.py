...
class Experiment:
    ...
    def train(self, args):
        ...
        for trial in range(args.ntrials):
            ...
            graph_learner = Stage_GNN_learner(1, features.shape[1], args.hidden_dim_cls, args.k, args.sim_function, 6, args.sparse,
            ...
            for epoch in range(1, args.epochs + 1):
                ...
                anchor_nodes_idx = torch.randperm(features.size(0))[:700]
                node_anchor_adj = graph_learner.forward_anchor(features, anchor_adj, anchor_nodes_idx, classifier.graph_encoders[0], 0.3)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-head_tail_mi', type=int, default=0)
